        ...
        <StyledWrapper>
          <StyledBody>
            <StyledLeftColumn>
              <StyledMainInfo>
                <StyledImg
                  src={formik.values.avatar || 'https://upload.wikimedia.org/wikipedia/commons/a/ac/Default_pfp.jpg'}
                />
                <TabList activeTabId={activeTab} noBorder isColumn>
                  ...
                  <Tab onClick={handleDeleteAccount}>
                    {delete_loader ? <Loader size={30} /> : <Typography value='Delete account' customColor='#ef5533' />}
                  </Tab>
                </TabList>
              </StyledMainInfo>
            </StyledLeftColumn>
