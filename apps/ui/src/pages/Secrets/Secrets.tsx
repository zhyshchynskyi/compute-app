...
const Secrets = () => {
  ...
  const { handleOpenCreateCredentialModal } = useCredentials()
  ...
  const buttonProperties = [
    ...
    { label: 'Add Credential', onClick: handleOpenCreateCredentialModal },
            ...
            <StyledChatWrapper>
              <StyledTabListWrapper>
                <TabList activeTabId={activeTab} noBorder>
                  ...
                  <Tab onClick={() => handleTabClick(1)}>Credentials</Tab>
                  <Tab onClick={() => handleTabClick(2)}>SSH Keys</Tab>
                </TabList>
                <div>
                  <ButtonPrimary
