      ...
      <div id="header_group">
        <StyledHeaderGroup>
          <StyledTextHeaderWrapper>
            <HeadingPrimary type={Heading.types?.h1} size={Heading.sizes?.LARGE} value="My Profile" />
          </StyledTextHeaderWrapper>
          <StyledButtonsContainer>
            <StyledChangePasswordButton onClick={openCreateChangePasswordModal} size={Button.sizes?.MEDIUM}>
              <TypographyPrimary value={t('change-password')} type={TypographyTypes.LABEL} size={TypographySizes.sm} />
