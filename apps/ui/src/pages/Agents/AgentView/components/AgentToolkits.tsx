...
const AgentToolkits = ({ tools }: { tools: string[] }) => {
  ...
  return (
    <StyledWrapper>
      <TypographyPrimary value={`${t('toolkit')}`} type={Typography.types.LABEL} size={Typography.sizes.lg} />
        ...
        return (
          <StyledToolkit key={index}>
            ...
            <StyledMainTextWrapper>
              <TypographyPrimary value={tool.name} type={Typography.types.LABEL} size={Typography.sizes.sm} />
              <TypographySecondary value={tool.description} type={Typography.types.LABEL} size={Typography.sizes.xss} />
            </StyledMainTextWrapper>
          </StyledToolkit>
        );
      })}
