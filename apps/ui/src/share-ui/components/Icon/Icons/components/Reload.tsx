  ...
  <svg viewBox='0 0 32 32' fill='currentColor' width={size || '32'} height={size || '32'} {...props}>
    <g filter='url(#filter0_bd_761_16745)'>
      <g clipPath='url(#clip0_761_16745)'>
        <path
          d='M11.25 12.6291C13.0449 9.52023 17.0202 8.45505 20.1291 10.25C23.238 12.0449 24.3032 16.0202 22.5083 19.1291C20.7134 22.238 16.738 23.3032 13.6291 21.5083C12.1874 20.6759 11.1852 19.3746 10.7039 17.9083M9.2509 18.9805L10.3342 17.1041C10.5337 16.7587 10.9754 16.6403 11.3208 16.8398L13.1972 17.9231'
          stroke='#fff'
          strokeLinecap='round'
        />
      </g>
