...
const Collapse: React.FC<CollapseProps> = ({ size, ...props }) => (
  <svg viewBox='0 0 32 32' fill='currentColor' width={size || '32'} height={size || '32'} {...props}>
    <g filter='url(#filter0_bd_761_16543)'>
      <path
        d='M23 23L18.0503 18.0503M9 9L13.9497 13.9497M23 17L18.0607 17C17.4749 17 17 17.4749 17 18.0607L17 23M15 9L15 13.9393C15 14.5251 14.5251 15 13.9393 15H9'
        stroke='#fff'
        strokeLinecap='round'
      />
    </g>
