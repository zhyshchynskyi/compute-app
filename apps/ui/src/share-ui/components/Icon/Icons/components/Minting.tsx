...
const Minting: React.FC<MintingProps> = ({ size, ...props }) => (
  <svg viewBox='0 0 40 40' fill='currentColor' width={size || '40'} height={size || '40'} {...props}>
    <path
      d='M20 23.5C21.933 23.5 23.5 21.933 23.5 20C23.5 18.067 21.933 16.5 20 16.5C18.067 16.5 16.5 18.067 16.5 20C16.5 21.933 18.067 23.5 20 23.5Z'
      fill='#fff'
      stroke='#fff'
      strokeLinecap='round'
