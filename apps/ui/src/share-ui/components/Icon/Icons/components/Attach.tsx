...
const Attach: React.FC<AttachProps> = ({ size, ...props }) => (
  <svg viewBox='0 0 32 32' fill='currentColor' width={size || '32'} height={size || '32'} {...props}>
    <g filter='url(#filter0_bd_5714_42096)'>
      <path
        d='M17 11.5128V21.5641C17 22.3571 16.3284 23 15.5 23C14.6716 23 14 22.3571 14 21.5641V11.8718C14 10.2857 15.3431 9 17 9C18.6569 9 20 10.2857 20 11.8718V18.3333'
        stroke='#fff'
        strokeLinecap='round'
      />
    </g>
