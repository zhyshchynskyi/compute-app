...
const Toggle: React.FC<ToggleProps> = ({ size, ...props }) => (
  <svg viewBox='0 0 32 32' fill='currentColor' width={size || '32'} height={size || '32'} {...props}>
    <g filter='url(#filter0_bd_5377_46298)'>
      <path
        d='M15.3 13.4H20.9C22.0598 13.4 23 14.3402 23 15.5C23 16.6598 22.0598 17.6 20.9 17.6H15.3M16 15.5C16 17.433 14.433 19 12.5 19C10.567 19 9 17.433 9 15.5C9 13.567 10.567 12 12.5 12C14.433 12 16 13.567 16 15.5Z'
        stroke='#fff'
      />
    </g>
    <defs>
      <filter
        id='filter0_bd_5377_46298'
        x='-10'
        y='-10'
        width='52'
        height='52'
