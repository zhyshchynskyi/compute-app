...
const Expand: React.FC<ExpandProps> = ({ size, ...props }) => (
  <svg viewBox='0 0 32 32' fill='currentColor' width={size || '32'} height={size || '32'} {...props}>
    <g filter='url(#filter0_bd_761_16563)'>
      <path
        d='M14.3501 17.6499L10.2253 21.7747M17.6499 14.3501L21.7747 10.2253M16 23H10.2374C9.55402 23 9 22.446 9 21.7626V16M23 16V10.2374C23 9.55402 22.446 9 21.7626 9H16'
        stroke='#fff'
        strokeLinecap='round'
      />
    </g>
