...
const PlayOutline: React.FC<PlayOutlineProps> = ({ size, ...props }) => (
  <svg viewBox='0 0 40 40' fill='currentColor' width={size || '40'} height={size || '40'} {...props}>
    <g filter='url(#filter0_bd_718_13946)'>
      <path
        d='M32.5 19.134C33.1667 19.5189 33.1667 20.4811 32.5 20.866L14.5 31.2583C13.8333 31.6432 13 31.1621 13 30.3923L13 9.60769C13 8.83789 13.8333 8.35677 14.5 8.74167L32.5 19.134Z'
        stroke='#fff'
        strokeWidth='2'
      />
    </g>
