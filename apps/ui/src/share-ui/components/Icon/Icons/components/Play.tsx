...
const Play: React.FC<PlayProps> = ({ size, ...props }) => (
  <svg viewBox='0 0 32 32' fill='currentColor' width={size || '32'} height={size || '32'} {...props}>
    <g filter='url(#filter0_bd_761_16748)'>
      <path
        d='M11 20.3601V10.6399C11 9.28182 12.6248 8.51443 13.747 9.34246L20.334 14.2026C21.222 14.8578 21.222 16.1422 20.334 16.7974L13.747 21.6575C12.6248 22.4856 11 21.7182 11 20.3601Z'
        stroke='#fff'
        strokeLinecap='round'
      />
    </g>
